...
def ShashlikFaces(object, c1, event, util):
	...
	if util.accumulate==True:
		...
		hMapFront.SetTitle('Upstream Face ADC')
		hMapBack.SetTitle('Downstream Face ADC')
