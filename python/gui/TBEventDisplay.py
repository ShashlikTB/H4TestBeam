...
class TBEventDisplay:
    ...
    def __init__(self, title, filename=None, width=WIDTH, height=HEIGHT):
        ...
        WFbuttons = [('Board 16','toggleShowBoard16','toggleShowBoard16',True),('Board 103','toggleShowBoard103','toggleShowBoard103',True),('Board 112','toggleShowBoard112','toggleShowBoard112',True),('Board 115','toggleShowBoard115','toggleShowBoard115',True)]
